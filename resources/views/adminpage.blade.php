...
<body>
  ...
  <div class="wrapper">
    ...
    <div class="sidebar" id="sidebar">
        ...
        <a href="index.html"><i class="fas fa-th-large"></i> Dashboard</a> <!--tembak ke diri sendiri-->
        <a href="user-list.html"><i class="fas fa-users"></i> User List</a> <!--tembak ke "adminpage-userlist.blade.php"-->
